...
public class FixedSizeBenchmarkConfig implements Cloneable {
   ...
   public void addOriginalStage(Stage stage) {
      originalStackStages.add(stage);
   }

   public List<Stage> getOriginalStages() {
      return new ArrayList<Stage>(originalStackStages);
   }

   public void setOriginalStages(List<Stage> stages) {
      this.originalStackStages = new ArrayList<Stage>(stages);
   }
   ...
   /**
    * Returns true if there is a next stage to execute <br> ATTENTION: the stage stack is saved using a ThreadLocal
    *
    * @return Stage
    */
   ...
   /**
    * Returns next stage<br> ATTENTION: the stage stack is saved using a ThreadLocal
    *
    * @return Stage
    */
