...
import org.radargun.stages.BenchmarkStage;
    ...
    private ScalingBenchmarkConfig buildBenchmarkPrototype(Element configRoot) {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (child instanceof Element) {
                ...
                if (st instanceof BenchmarkStage) {
                    ...
                    for (int j = 0; j < stageChildNodes.getLength(); j++) {
                        ...
                        if (workloadChild instanceof Element) {
                            ...
                            ((BenchmarkStage) st).setWorkloadGenerator(wg);
                    ...
                    if (((BenchmarkStage) st).getWorkloadGenerator() == null) {
