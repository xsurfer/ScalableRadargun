...
public class Parameters {
   ...
   /**
    * the number of nodes in the Radargun cluster. BE CAREFUL, in this version of radargun this number have to be
    * dynamic, so read the value in the cache
    */
   ...
   public void setStartPoint(CountDownLatch val) {
      startPoint = val;
   }

   public long getSimulationTimeSec() {
      return simulationTimeSec;
   }
