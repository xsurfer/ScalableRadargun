...
/**
 * Created by: Fabio Perfetti E-mail: perfabio87@gmail.com Date: 3/22/13
 */
public class WorkerThreadFactory implements ThreadFactory {
   ...
   /**
    * This constructor creates a WorkerThreadFactory.<br/> It should create unique thread (thread's name) or multiple
    * thread setting its name to 'prefix-<counter>'
    *
    * @param prefix
    * @param unique
    */
