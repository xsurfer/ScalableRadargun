...
public class StringByteIterator extends ByteIterator {
   ...
   /**
    * Specialization of general purpose toString() to avoid unnecessary copies. <p> Creating a new StringByteIterator,
    * then calling toString() yields the original String object, and does not perform any copies or String conversion
    * operations. </p>
    */
   @Override
